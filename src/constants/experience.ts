...
export const EXPERIENCE_DATA: ExperienceRole[] = [
  {
    ...
    highlights: [
      ...
      'Engineered core modules for an ERP platform, designing how data flows and connects across modules to replace manual business processes.',
      ...
      'Translated Figma designs into responsive, multilingual frontends for multiple client websites, refining through rounds of client feedback.',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Built end-to-end features for a production, client-facing web app using microservice architecture, supporting real-world user workflows.',
